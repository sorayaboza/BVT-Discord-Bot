...
// To run & allow changes, type: nodemon app
// When running, go to http://127.0.0.1:9000/voiceTime to find the totalVoiceData.json. It is also uploaded to Mongo Compass.
...
const  app = express() // Creating app by invoking the express function.
const port = 9000
const host = 'http://127.0.0.1:' + port



app.use(json()) // Express uses the json() method to enable parsing of JSON data in incoming requests.
app.listen(port, () => console.log(host)) // Start the server on the specified port & log the host URL to the console.

// VOICE COLLECTION (BELOW) -----------------------------------------------------------------------------------------------------------
